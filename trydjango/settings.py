...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY','django-insecure-ohsth-br_)%m0egsb$yt-)8c&%jzi2nomxncyv$t$eo1!hb5d@')
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / "templates",
            'D:\Coding Course\Belajar Python\Belajar_Django\\templates',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
